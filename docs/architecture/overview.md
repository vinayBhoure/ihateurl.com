...
src/
  ...
  app/
    ...
    (public)/                   Built: layout (header, footer, skip link), / (landing, F4.1; v2 hero, product frame, how it works: plan 3 L1.1–L1.2), error, /[username] (F4.2), /[username]/[slug] (F4.3), /explore (F4.4)
    login/, signup/             Built
    app/
